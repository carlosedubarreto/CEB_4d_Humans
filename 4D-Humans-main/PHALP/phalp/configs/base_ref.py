...
#venv Path
# path_addon = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
# print('path phalp config: ',path_addon)
# path_venv_path_txt = os.path.join(path_addon,'venv_path.txt')
# env_has_path_txt = 0
...
# print('path phalp config txt: ',path_txt)
# CACHE_DIR = os.path.join(path_txt, ".cache")
...
class PHALPConfig:
    ...
    n_init: int = 5 #quantidade minima pra rodar antes de trazer os dados
    encode_type: str = '4c'
    past_lookback: int = 1
    detector: str = 'vitdet'
    shot: int = 0
...
class RenderConfig:
    # enable: bool = True
    enable: bool = False #Nao rendereizar o resultado
