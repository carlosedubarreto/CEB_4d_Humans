...
import sys
sys.path.insert(0,'phalp')#quando usando no blender
# sys.path.insert(0,'4D-Humans-main/PHALP') #quando debugando fora do blender
...
def main(cfg: DictConfig) -> Optional[float]:
    ...
    print('----------')
    print('Detector: ',cfg['phalp'].detector)
    print('----------')
